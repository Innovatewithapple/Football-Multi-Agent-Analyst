...
from ApiRequests import player_context_Node, supervised_Node,matchup_context_Node,matchup_agent_Node,player_context_Node,player_agent_Node,news_context_node,news_agent_Node,final_agent_node
...
async def main():
   query = "Compare Cristiano Ronaldo, Lionel Messi, and Kylian Mbappé based on their recent performances, current form, and the latest football news."
